  ...
  extends WebChromeClient
{
  ...
  {
    paramFileChooserParams = paramFileChooserParams.createIntent();
    try
    {
      CordovaInterface localCordovaInterface = this.parentEngine.cordova;
      paramWebView = new org/apache/cordova/engine/SystemWebChromeClient$5;
      paramWebView.<init>(this, paramValueCallback);
      localCordovaInterface.startActivityForResult(paramWebView, paramFileChooserParams, 5173);
      return true;
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\org\apache\cordova\engine\SystemWebChromeClient.class
