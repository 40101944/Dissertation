    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (((Matcher)localObject1).matches())
        {
          ...
          ((URLPattern)localObject2).<init>("http", str1, str2, (String)localObject1);
          ((ArrayList)localObject3).add(localObject2);
          localObject2 = this.whiteList;
          localObject3 = new org/apache/cordova/Whitelist$URLPattern;
          ((URLPattern)localObject3).<init>("https", str1, str2, (String)localObject1);
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\org\apache\cordova\Whitelist.class
