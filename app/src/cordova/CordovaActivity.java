  ...
  extends Activity
{
    ...
    runOnUiThread(new Runnable()
    {
      public void run()
      {
        try
        {
          ...
          DialogInterface.OnClickListener local1 = new org/apache/cordova/CordovaActivity$4$1;
          local1.<init>(this);
  ...
  public void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    {
      return;
      PluginManager localPluginManager = this.appView.getPluginManager();
  ...
  {
    LOG.i(TAG, "Apache Cordova native platform version 5.2.1 is starting");
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\org\apache\cordova\CordovaActivity.class
