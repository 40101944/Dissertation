...
public class ConfigXmlParser
{
  ...
  private void setStartUrl(String paramString)
  {
    ...
    String str;
    for (this.launchUrl = paramString;; this.launchUrl = ("file:///android_asset/www/" + str))
    {
      return;
      str = paramString;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\org\apache\cordova\ConfigXmlParser.class
