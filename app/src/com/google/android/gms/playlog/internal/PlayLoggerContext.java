  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((paramObject instanceof PlayLoggerContext))
      {
        ...
        if ((this.versionCode != ((PlayLoggerContext)paramObject).versionCode) || (!this.packageName.equals(((PlayLoggerContext)paramObject).packageName)) || (this.aAB != ((PlayLoggerContext)paramObject).aAB) || (this.aAC != ((PlayLoggerContext)paramObject).aAC) || (!zzz.equal(this.aAG, ((PlayLoggerContext)paramObject).aAG)) || (!zzz.equal(this.aAD, ((PlayLoggerContext)paramObject).aAD)) || (!zzz.equal(this.aAE, ((PlayLoggerContext)paramObject).aAE)) || (this.aAF != ((PlayLoggerContext)paramObject).aAF) || (this.aAH != ((PlayLoggerContext)paramObject).aAH) || (this.aAI != ((PlayLoggerContext)paramObject).aAI)) {
          bool = false;
        }
      }
      else
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\playlog\internal\PlayLoggerContext.class
