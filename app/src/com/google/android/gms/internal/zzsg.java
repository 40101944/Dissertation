...
public class zzsg
{
    ...
    implements IBinder.DeathRecipient, zzsg.zzb
  {
    ...
    private void zzaug()
    {
      zzqq localzzqq = (zzqq)this.BI.get();
      Object localObject = (zze)this.BJ.get();
      if ((localObject != null) && (localzzqq != null)) {
        ((zze)localObject).remove(localzzqq.zzarh().intValue());
      }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\internal\zzsg.class
