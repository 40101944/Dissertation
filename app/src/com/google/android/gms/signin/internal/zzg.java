  ...
  implements zzxp
{
  ...
  public void zza(zzd paramzzd)
  {
    ...
    {
      localObject = zzcdl();
      zze localzze = (zze)zzavg();
      SignInRequest localSignInRequest = new com/google/android/gms/signin/internal/SignInRequest;
      localSignInRequest.<init>((ResolveAccountRequest)localObject);
      localzze.zza(localSignInRequest, paramzzd);
      return;
    }
    catch (RemoteException localRemoteException)
    {
      for (;;)
      {
        ...
        try
        {
          localObject = new com/google/android/gms/signin/internal/SignInResponse;
          ((SignInResponse)localObject).<init>(8);
          paramzzd.zzb((SignInResponse)localObject);
        }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\signin\internal\zzg.class
