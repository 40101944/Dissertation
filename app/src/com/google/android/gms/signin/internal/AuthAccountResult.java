  ...
  implements Result
{
  ...
  {
    if (this.aDq == 0) {}
    for (Status localStatus = Status.xZ;; localStatus = Status.yd) {
      return localStatus;
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\signin\internal\AuthAccountResult.class
