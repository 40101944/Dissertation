  ...
  extends StatsEvent
{
  ...
  public String zzaxu()
  {
    ...
    String str7 = String.valueOf(zzaxv());
    ...
    {
      return String.valueOf(str8).length() + 37 + String.valueOf(str7).length() + String.valueOf(str6).length() + String.valueOf(str5).length() + String.valueOf(str1).length() + String.valueOf(str9).length() + String.valueOf(str10).length() + String.valueOf(str2).length() + String.valueOf(str11).length() + String.valueOf(str3).length() + String.valueOf(str12).length() + String.valueOf(str13).length() + String.valueOf(str4).length() + str8 + str7 + str6 + j + str5 + str1 + str9 + i + str10 + str2 + str11 + str3 + str12 + f + str13 + str4;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\common\stats\WakeLockEvent.class
