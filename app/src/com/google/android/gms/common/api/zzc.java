...
public abstract class zzc<O extends Api.ApiOptions>
{
  ...
  public Api.zze buildApiClient(Looper paramLooper, GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener)
  {
    ...
    if (this.xB == null)
    {
      ...
      localzzh = this.vS.zzaqu();
    }
    label80:
    for (paramLooper = new zzag(this.mContext, paramLooper, localzzh.zzaqz(), paramConnectionCallbacks, paramOnConnectionFailedListener, zzf.zzca(this.mContext), localzzh.zzr(this.xw));; paramLooper = this.vS.zzaqt().zza(this.mContext, paramLooper, zzf.zzca(this.mContext), this.xw, paramConnectionCallbacks, paramOnConnectionFailedListener))
    {
      return paramLooper;
      bool = false;
      break;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\common\api\zzc.class
