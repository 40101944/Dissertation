...
public final class zzf
{
  ...
  public static <K, V> Map<K, V> zzb(K[] paramArrayOfK, V[] paramArrayOfV)
  {
    ...
    for (;;)
    {
      ...
      paramArrayOfK = zze(paramArrayOfK[0], paramArrayOfV[0]);
      continue;
      localObject = new HashMap(j, 1.0F);
      break;
      paramArrayOfK = Collections.unmodifiableMap((Map)localObject);
    }
  }
  ...
  public static <T> Set<T> zzc(T... paramVarArgs)
  {
    ...
    {
      paramVarArgs = Collections.unmodifiableSet(paramVarArgs);
      for (;;)
      {
        return paramVarArgs;
        paramVarArgs = zzayj();
        continue;
        paramVarArgs = zzaa(paramVarArgs[0]);
        continue;
        paramVarArgs = zzd(paramVarArgs[0], paramVarArgs[1]);
        continue;
        paramVarArgs = zza(paramVarArgs[0], paramVarArgs[1], paramVarArgs[2]);
        continue;
        paramVarArgs = zza(paramVarArgs[0], paramVarArgs[1], paramVarArgs[2], paramVarArgs[3]);
      }
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\com\google\android\gms\common\util\zzf.class
