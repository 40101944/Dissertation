    ...
    for (;;)
    {
      ...
      if (i == 2)
      {
        ...
        for (;;)
        {
          ...
          localSimplePathStrategy.addRoot(str2, buildPath(paramString, new String[] { str1 }));
          break;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\content\FileProvider.class
