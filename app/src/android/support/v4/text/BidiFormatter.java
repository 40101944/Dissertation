...
public final class BidiFormatter
{
  ...
  {
    if (paramString == null) {}
    for (paramString = null;; paramString = unicodeWrap(paramString, paramTextDirectionHeuristicCompat, paramBoolean).toString()) {
      return paramString;
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\text\BidiFormatter.class
