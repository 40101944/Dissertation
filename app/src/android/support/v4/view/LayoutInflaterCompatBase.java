...
class LayoutInflaterCompatBase
{
  static LayoutInflaterFactory getFactory(LayoutInflater paramLayoutInflater)
  {
    ...
    for (paramLayoutInflater = ((FactoryWrapper)paramLayoutInflater).mDelegateFactory;; paramLayoutInflater = null) {
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\LayoutInflaterCompatBase.class
