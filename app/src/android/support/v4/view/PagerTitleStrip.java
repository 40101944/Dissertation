  ...
  extends ViewGroup
{
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    if (paramInt != this.mLastKnownCurrentPage)
    {
      ...
      i8 = Math.max(Math.max(i7 + i10, i + i9), i5 + i8);
    ...
    for (;;)
    {
      ...
      i = Math.max(i1 - n - k, this.mScaledTextSpacing + i4);
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\PagerTitleStrip.class
