  ...
  extends PagerTitleStrip
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    int k = this.mIndicatorHeight;
    this.mTabPaint.setColor(this.mTabAlpha << 24 | this.mIndicatorColor & 0xFFFFFF);
    paramCanvas.drawRect(m - i, j - k, i1 + n, j, this.mTabPaint);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    int i = n - this.mIndicatorHeight;
    localRect.set(k - j, i, m + i1, n);
    super.updateTextPositions(paramInt, paramFloat, paramBoolean);
    this.mTabAlpha = ((int)(Math.abs(paramFloat - 0.5F) * 2.0F * 255.0F));
    localRect.union(this.mCurrText.getLeft() - this.mTabPadding, i, this.mCurrText.getRight() + this.mTabPadding, n);
    invalidate(localRect);
  }
}


/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\PagerTabStrip.class
