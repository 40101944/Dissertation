...
public class ViewCompat
{
    ...
    implements ViewCompat.ViewCompatImpl
  {
    ...
    private boolean canScrollingViewScrollVertically(ScrollingView paramScrollingView, int paramInt)
    {
      ...
      int i = paramScrollingView.computeVerticalScrollRange() - paramScrollingView.computeVerticalScrollExtent();
      if (i == 0) {
        bool = false;
      }
      for (;;)
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\ViewCompat.class
