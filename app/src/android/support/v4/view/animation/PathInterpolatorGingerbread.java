    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          paramFloat = this.mY[i];
          paramFloat = (this.mY[j] - paramFloat) * f + paramFloat;
        }
      }
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\animation\PathInterpolatorGingerbread.class
