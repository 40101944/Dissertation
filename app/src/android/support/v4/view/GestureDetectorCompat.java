    ...
    implements GestureDetectorCompat.GestureDetectorCompatImpl
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      for (;;)
      {
        ...
        break label53;
        label109:
        f2 = f3 + paramMotionEvent.getX(m);
        f3 = f1 + paramMotionEvent.getY(m);
        f1 = f2;
        f2 = f3;
      }
      label137:
          ...
          if (!this.mInLongPress)
          {
            ...
            else
            {
              ...
              if (this.mAlwaysInTapRegion)
              {
                ...
                j = (int)(f4 - this.mDownFocusY);
                j = k * k + j * j;
                bool3 = bool4;
                if (j > this.mTouchSlopSquare)
                {
                  bool3 = this.mListener.onScroll(this.mCurrentDownEvent, paramMotionEvent, f3, f1);
                  this.mLastFocusX = f2;
                  this.mLastFocusY = f4;
                  this.mAlwaysInTapRegion = false;
                  this.mHandler.removeMessages(3);
              ...
              {
                bool2 = this.mListener.onScroll(this.mCurrentDownEvent, paramMotionEvent, f3, f1);
                this.mLastFocusX = f2;
                this.mLastFocusY = f4;
                continue;
                this.mStillDown = false;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\GestureDetectorCompat.class
