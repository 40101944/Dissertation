  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt2 > 0) && (!this.mItems.isEmpty()))
    {
      ...
      for (;;)
      {
        ...
        f = getScrollX() / (paramInt2 - j - m + paramInt4);
        scrollTo((int)((paramInt1 - k - i + paramInt3) * f), getScrollY());
      }
    }
  ...
  void dataSetChanged()
  {
    ...
    for (;;)
    {
      ...
      if (i3 == -2)
      {
        ...
        {
          m = Math.max(0, Math.min(this.mCurItem, i4 - 1));
          i = 1;
          i2 = i3;
          i1 = n;
        }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((m == 0) || ((m == 1) && (this.mAdapter != null) && (this.mAdapter.getCount() > 1)))
    {
      ...
      if (!this.mRightEdge.isFinished())
      {
        ...
        this.mRightEdge.setSize(i1 - n - i2, k);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i != -1)
      {
        ...
        float f1 = Math.abs(f3 - this.mInitialMotionY);
        if ((f5 != 0.0F) && (!isGutterDrag(this.mLastMotionX, f5)) && (canScroll(this, false, (int)f5, (int)f2, (int)f3)))
        {
        ...
        if ((f4 > this.mTouchSlop) && (0.5F * f4 > f1))
        {
    ...
    if (k < i5)
    {
      ...
      if (((View)localObject2).getVisibility() != 8)
      {
        ...
        if (localObject1 != null)
        {
          ...
          {
            j = ((LayoutParams)localObject1).gravity & 0x7;
            m = ((LayoutParams)localObject1).gravity & 0x70;
            ...
            if (((LayoutParams)localObject1).width != -2)
            {
              ...
              {
                i2 = ((LayoutParams)localObject1).width;
                j = i4;
              }
            }
            i3 = i;
            ...
            if (((LayoutParams)localObject1).height != -2)
            {
              ...
              {
                i = ((LayoutParams)localObject1).height;
                i3 = i4;
              }
            }
            ((View)localObject2).measure(View.MeasureSpec.makeMeasureSpec(i2, j), View.MeasureSpec.makeMeasureSpec(i, i3));
            if (m == 0) {
              break label381;
            }
            i = paramInt2 - ((View)localObject2).getMeasuredHeight();
            j = paramInt1;
          }
        }
      }
      for (;;)
      {
        ...
        if (n != 0)
        {
          j = paramInt1 - ((View)localObject2).getMeasuredWidth();
          i = paramInt2;
        }
      }
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\view\ViewPager.class
