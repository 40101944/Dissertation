  ...
  static Object newInstance(List<MediaBrowser.MediaItem> paramList)
  {
    ...
    catch (InstantiationException paramList)
    {
      for (;;)
      {
        ...
        paramList = (List<MediaBrowser.MediaItem>)localObject;
      }
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\ParceledListSliceAdapterApi21.class
