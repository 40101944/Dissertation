...
class MediaBrowserServiceCompatApi21
{
    ...
    extends MediaBrowserService
  {
    ...
    public MediaBrowserService.BrowserRoot onGetRoot(String paramString, int paramInt, Bundle paramBundle)
    {
      ...
      if (paramString == null) {}
      for (paramString = null;; paramString = new MediaBrowserService.BrowserRoot(paramString.mRootId, paramString.mExtras)) {
        return paramString;
      }
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserServiceCompatApi21.class
