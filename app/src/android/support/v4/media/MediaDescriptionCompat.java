  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<MediaDescriptionCompat> CREATOR = new Parcelable.Creator()
  {
    public MediaDescriptionCompat createFromParcel(Parcel paramAnonymousParcel)
    {
      ...
      for (paramAnonymousParcel = new MediaDescriptionCompat(paramAnonymousParcel);; paramAnonymousParcel = MediaDescriptionCompat.fromMediaDescription(MediaDescriptionCompatApi21.fromParcel(paramAnonymousParcel))) {
    ...
    for (Object localObject1 = this.mDescriptionObj;; localObject1 = this.mDescriptionObj)
    {
      ...
      if (Build.VERSION.SDK_INT < 23)
      {
        ...
        if (this.mMediaUri != null)
        {
          ...
          ((Bundle)localObject1).putParcelable("android.support.v4.media.description.MEDIA_URI", this.mMediaUri);
        }
      }
      MediaDescriptionCompatApi21.Builder.setExtras(localObject2, (Bundle)localObject1);
      if (Build.VERSION.SDK_INT >= 23) {
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\MediaDescriptionCompat.class
