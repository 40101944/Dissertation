...
public final class MediaControllerCompat
{
    ...
    implements IBinder.DeathRecipient
  {
    ...
    public Callback()
    {
      ...
      for (this.mCallbackObj = MediaControllerCompatApi21.createCallback(new StubApi21());; this.mCallbackObj = new StubCompat()) {
        return;
      }
    }
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public List<MediaSessionCompat.QueueItem> getQueue()
    {
      ...
      if (localList != null) {}
      for (localList = MediaSessionCompat.QueueItem.fromQueueItemList(localList);; localList = null) {
        return localList;
      }
    }
    ...
    extends MediaControllerCompat.MediaControllerImplApi23
  {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      Object localObject = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
      if (localObject != null) {}
      for (localObject = new MediaControllerCompat.TransportControlsApi24(localObject);; localObject = null) {
        return (MediaControllerCompat.TransportControls)localObject;
      }
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
