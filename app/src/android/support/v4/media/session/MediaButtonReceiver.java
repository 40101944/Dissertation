  ...
  extends BroadcastReceiver
{
  ...
  public static PendingIntent buildMediaButtonPendingIntent(Context paramContext, long paramLong)
  {
    ...
    for (paramContext = null;; paramContext = buildMediaButtonPendingIntent(paramContext, localComponentName, paramLong)) {
      return paramContext;
    }
  }
  ...
  static ComponentName getMediaButtonReceiverComponent(Context paramContext)
  {
    ...
    for (paramContext = new ComponentName(paramContext.activityInfo.packageName, paramContext.activityInfo.name);; paramContext = null)
    {
      return paramContext;
      if (paramContext.size() > 1) {
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\session\MediaButtonReceiver.class
