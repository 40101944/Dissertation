  ...
  extends Service
{
  ...
  void addSubscription(String paramString, ConnectionRecord paramConnectionRecord, IBinder paramIBinder, Bundle paramBundle)
  {
    ...
    } while ((paramIBinder != localPair.first) || (!MediaBrowserCompatUtils.areSameOptions(paramBundle, (Bundle)localPair.second)));
    for (;;)
    {
      return;
  ...
  List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> paramList, Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      int m = paramBundle.getInt("android.media.browse.extra.PAGE", -1);
      int i = paramBundle.getInt("android.media.browse.extra.PAGE_SIZE", -1);
      if (m == -1)
      {
    ...
    implements MediaBrowserServiceCompat.MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy
  {
    ...
    public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String paramString, int paramInt, Bundle paramBundle)
    {
      ...
      for (;;)
      {
        paramString = new MediaBrowserServiceCompatApi21.BrowserRoot(paramBundle.getRootId(), paramString);
        break;
    ...
    implements MediaBrowserServiceCompat.MediaBrowserServiceImpl
  {
    ...
    public Bundle getBrowserRootHints()
    {
      ...
      if (MediaBrowserServiceCompat.this.mCurConnection.rootHints == null) {}
      for (Bundle localBundle = null;; localBundle = new Bundle(MediaBrowserServiceCompat.this.mCurConnection.rootHints)) {
        return localBundle;
      }
    }
    ...
    public IBinder onBind(Intent paramIntent)
    {
      ...
      for (paramIntent = this.mMessenger.getBinder();; paramIntent = null) {
        return paramIntent;
      }
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserServiceCompat.class
