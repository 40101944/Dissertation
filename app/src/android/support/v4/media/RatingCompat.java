  ...
  implements Parcelable
{
  ...
  public static RatingCompat fromRating(Object paramObject)
  {
    ...
    localObject1 = newHeartRating(RatingCompatKitkat.hasHeart(paramObject));
    for (;;)
    {
      ((RatingCompat)localObject1).mRatingObj = paramObject;
      break;
      localObject1 = newThumbRating(RatingCompatKitkat.isThumbUp(paramObject));
      continue;
      localObject1 = newStarRating(i, RatingCompatKitkat.getStarRating(paramObject));
      continue;
      localObject1 = newPercentageRating(RatingCompatKitkat.getPercentRating(paramObject));
      continue;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\media\RatingCompat.class
