...
public final class TimeUtils
{
  ...
  private static int formatDurationLocked(long paramLong, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      paramInt = 1;
      label366:
      i1 = printField(arrayOfChar, i1, 'd', i2, false, 0);
      if (i1 == i2) {
        break label527;
      }
      bool = true;
      ...
      j = 2;
      label398:
      m = printField(arrayOfChar, m, 'h', i1, bool, j);
      if (m == i2) {
        break label539;
      }
      bool = true;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\util\TimeUtils.class
