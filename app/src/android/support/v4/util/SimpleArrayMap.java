      ...
      if ((paramObject instanceof SimpleArrayMap))
      {
        ...
        else
        {
          ...
          try
          {
            ...
            paramObject = ((SimpleArrayMap)localObject1).get(localObject3);
            if (localObject2 == null)
            {
              if ((paramObject != null) || (!((SimpleArrayMap)localObject1).containsKey(localObject3))) {
                bool1 = false;
              }
            }
            else
            {
              bool1 = localObject2.equals(paramObject);
              if (!bool1)
              {
                bool1 = false;
                continue;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\util\SimpleArrayMap.class
