  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    for (;;)
    {
      ...
      for (bool = ((Fragment)localObject3).getAllowReturnTransitionOverlap();; bool = ((Fragment)localObject3).getAllowEnterTransitionOverlap())
      {
        ...
        if (localObject3 != null)
        {
          FragmentTransitionCompat21.addTransitionTargets(localObject4, paramSparseArray2, localObject2, localViewGroup, (FragmentTransitionCompat21.ViewRetriever)localObject6, paramTransitionState.nonExistentView, paramTransitionState.enteringEpicenterView, paramTransitionState.nameOverrides, (ArrayList)localObject5, (ArrayList)localObject1, paramSparseArray1, localArrayMap, localArrayList);
          ...
          FragmentTransitionCompat21.cleanupTransitions(localViewGroup, paramTransitionState.nonExistentView, localObject4, (ArrayList)localObject5, localObject2, (ArrayList)localObject1, paramSparseArray2, localArrayList, localObject3, paramTransitionState.hiddenFragmentViews, localArrayMap);
        }
        if (localObject3 == null) {
          break label496;
        }
  ...
  private void setNameOverrides(TransitionState paramTransitionState, ArrayMap<String, View> paramArrayMap, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      String str2 = (String)paramArrayMap.keyAt(i);
      String str1 = FragmentTransitionCompat21.getTransitionName((View)paramArrayMap.valueAt(i));
      if (paramBoolean) {
  ...
  public void run()
  {
    ...
    if (SUPPORTS_TRANSITIONS)
    {
      ...
      if (this.mManager.mCurState >= 1)
      {
        ...
        localObject2 = beginTransition((SparseArray)localObject2, (SparseArray)localObject1, false);
      }
    }
    int i;
    label134:
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\app\BackStackRecord.class
