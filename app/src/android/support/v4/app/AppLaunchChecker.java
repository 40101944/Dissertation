...
public class AppLaunchChecker
{
  ...
  public static void onActivityCreate(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      if ((paramActivity != null) && ("android.intent.action.MAIN".equals(paramActivity.getAction())) && ((paramActivity.hasCategory("android.intent.category.LAUNCHER")) || (paramActivity.hasCategory("android.intent.category.LEANBACK_LAUNCHER")))) {
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\app\AppLaunchChecker.class
