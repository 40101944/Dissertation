...
public class NotificationCompat
{
  ...
  static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor, Style paramStyle)
  {
    if (paramStyle != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        paramStyle.add(localMessage.getText());
        localArrayList3.add(Long.valueOf(localMessage.getTimestamp()));
        localArrayList4.add(localMessage.getSender());
        localArrayList2.add(localMessage.getDataMimeType());
        localArrayList1.add(localMessage.getDataUri());
      }
      NotificationCompatApi24.addMessagingStyle(paramNotificationBuilderWithBuilderAccessor, localMessagingStyle.mUserDisplayName, localMessagingStyle.mConversationTitle, paramStyle, localArrayList3, localArrayList4, localArrayList2, localArrayList1);
    }
    for (;;)
    {
      return;
  ...
  public static class Builder
  {
    ...
    {
      if (this.mShowWhen) {}
      for (long l = this.mNotification.when;; l = 0L) {
        return l;
      }
    }
    ...
    extends NotificationCompat.Style
  {
    ...
    public static MessagingStyle extractMessagingStyleFromNotification(Notification paramNotification)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          paramNotification = new android/support/v4/app/NotificationCompat$MessagingStyle;
          paramNotification.<init>();
          paramNotification.restoreFromCompatExtras(localBundle);
        }
    ...
    public static final class Message
    {
      ...
      static Message getMessageFromBundle(Bundle paramBundle)
      {
        for (;;)
        {
          ...
          localMessage = new android/support/v4/app/NotificationCompat$MessagingStyle$Message;
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\app\NotificationCompat.class
