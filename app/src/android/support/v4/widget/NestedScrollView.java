  ...
  implements NestedScrollingParent, NestedScrollingChild, ScrollingView
{
  ...
  public void computeScroll()
  {
    ...
    if (this.mScroller.computeScrollOffset())
    {
      ...
      if ((i1 != i2) || (k != m))
      {
        ...
        overScrollByCompat(i2 - i1, m - k, i1, k, 0, n, 0, 0, false);
        if (i != 0)
        {
          ensureGlows();
          if ((m > 0) || (k <= 0)) {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.mEdgeGlowTop != null)
    {
      ...
      if (!this.mEdgeGlowTop.isFinished())
      {
        ...
        this.mEdgeGlowTop.setSize(k - n - m, getHeight());
  ...
  public final void smoothScrollBy(int paramInt1, int paramInt2)
  {
    ...
    if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250L)
    {
      ...
      int i = getPaddingTop();
      i = Math.max(0, getChildAt(0).getHeight() - (paramInt1 - j - i));
      paramInt1 = getScrollY();
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
