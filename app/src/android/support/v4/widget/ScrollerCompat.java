...
public final class ScrollerCompat
{
  ...
  public float getCurrVelocity()
  {
    ...
    for (float f = ScrollerCompatIcs.getCurrVelocity(this.mScroller);; f = 0.0F) {
      return f;
    }
  }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\widget\ScrollerCompat.class
