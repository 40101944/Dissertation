  ...
  extends ImageView
{
    ...
    extends OvalShape
  {
    ...
    private void updateRadialGradient(int paramInt)
    {
      float f2 = paramInt / 2;
      float f3 = paramInt / 2;
      float f1 = CircleImageView.this.mShadowRadius;
      Shader.TileMode localTileMode = Shader.TileMode.CLAMP;
      this.mRadialGradient = new RadialGradient(f2, f3, f1, new int[] { 1023410176, 0 }, null, localTileMode);
    ...
    public void draw(Canvas paramCanvas, Paint paramPaint)
    {
      ...
      paramCanvas.drawCircle(j / 2, i / 2, j / 2, this.mShadowPaint);
      paramCanvas.drawCircle(j / 2, i / 2, j / 2 - CircleImageView.this.mShadowRadius, paramPaint);
    }
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\widget\CircleImageView.class
