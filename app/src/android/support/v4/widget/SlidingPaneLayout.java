  ...
  extends ViewGroup
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      f2 = f1 + ((LayoutParams)localObject2).weight;
      bool2 = bool1;
      i2 = i;
      f1 = f2;
      j = m;
    } while (((LayoutParams)localObject2).width == 0);
    label393:
    paramInt1 = ((LayoutParams)localObject2).leftMargin + ((LayoutParams)localObject2).rightMargin;
    if (((LayoutParams)localObject2).width == -2)
    {
      ...
      label445:
      ((View)localObject1).measure(paramInt1, j);
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      paramInt1 = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject2).width, 1073741824);
      break label426;
      ...
      j = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject2).height, 1073741824);
      break label445;
    }
    label650:
    if ((bool1) || (f1 > 0.0F))
      ...
      if (j < i4)
      {
        ...
        for (;;)
        {
          ...
          if (((View)localObject2).getVisibility() != 8)
          {
            ...
            for (;;)
            {
              ((View)localObject2).measure(View.MeasureSpec.makeMeasureSpec(i1, 1073741824), paramInt1);
              break;
              paramInt1 = 0;
              break label744;
              label834:
              ...
              {
                paramInt1 = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject1).height, 1073741824);
                continue;
                label879:
                paramInt1 = View.MeasureSpec.makeMeasureSpec(((View)localObject2).getMeasuredHeight(), 1073741824);
              }
            }
            label894:
            if (((LayoutParams)localObject1).weight > 0.0F)
            {
              ...
              for (;;)
              {
                ...
                i2 = i3 - (((LayoutParams)localObject1).leftMargin + ((LayoutParams)localObject1).rightMargin);
                int i5 = View.MeasureSpec.makeMeasureSpec(i2, 1073741824);
                if (n == i2) {
                  break;
                }
                ((View)localObject2).measure(i5, paramInt1);
                break;
                if (((LayoutParams)localObject1).height == -1)
                {
                  paramInt1 = View.MeasureSpec.makeMeasureSpec(paramInt2, 1073741824);
              ...
              label1029:
              i2 = Math.max(0, m);
              ((View)localObject2).measure(View.MeasureSpec.makeMeasureSpec(n + (int)(((LayoutParams)localObject1).weight * i2 / f1), 1073741824), paramInt1);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      case 1: 
        ...
        if (isDimmed(this.mSlideableView))
        {
          ...
          f1 = f2 - this.mInitialMotionY;
          i = this.mDragHelper.getTouchSlop();
          bool1 = bool2;
          if (f4 * f4 + f1 * f1 < i * i)
          {
            bool1 = bool2;
            if (this.mDragHelper.isViewUnder(this.mSlideableView, (int)f3, (int)f2))
            {
  ...
  boolean smoothSlideTo(float paramFloat, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        j = getPaddingRight();
        paramInt = localLayoutParams.rightMargin;
        i = this.mSlideableView.getWidth();
      }
      for (paramInt = (int)(getWidth() - (j + paramInt + this.mSlideRange * paramFloat + i));; paramInt = (int)(getPaddingLeft() + localLayoutParams.leftMargin + this.mSlideRange * paramFloat))
      {
  ...
  void updateObscuredViewsVisibility(View paramView)
  {
    ...
    if (bool)
    {
      ...
      i3 = Math.min(i5 - i6, localView.getBottom());
    ...
    extends ViewDragHelper.Callback
  {
    ...
    public int clampViewPositionHorizontal(View paramView, int paramInt1, int paramInt2)
    {
      ...
      {
        i = SlidingPaneLayout.this.getWidth() - (SlidingPaneLayout.this.getPaddingRight() + paramView.rightMargin + SlidingPaneLayout.this.mSlideableView.getWidth());
        paramInt2 = SlidingPaneLayout.this.mSlideRange;
      }
      for (paramInt1 = Math.max(Math.min(paramInt1, i), i - paramInt2);; paramInt1 = Math.min(Math.max(paramInt1, i), i + paramInt2))
      {
        return paramInt1;
    ...
    public void onViewDragStateChanged(int paramInt)
    {
      ...
      for (SlidingPaneLayout.this.mPreservedOpenState = false;; SlidingPaneLayout.this.mPreservedOpenState = true)
      {
        return;
        label62:
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\widget\SlidingPaneLayout.class
