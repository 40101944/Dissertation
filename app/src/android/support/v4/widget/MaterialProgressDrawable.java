  ...
  implements Animatable
{
  ...
  private int evaluateColorChange(float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    return (int)(((paramInt2 >> 24 & 0xFF) - i) * paramFloat) + i << 24 | (int)(((paramInt2 >> 16 & 0xFF) - j) * paramFloat) + j << 16 | (int)(((paramInt2 >> 8 & 0xFF) - paramInt1) * paramFloat) + paramInt1 << 8 | (int)(((paramInt2 & 0xFF) - k) * paramFloat) + k;
  }
  ...
  private void setupAnimators()
  {
    ...
    Animation local1 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        {
          return;
          float f3 = MaterialProgressDrawable.this.getMinProgressArc(localRing);
          ...
          if (paramAnonymousFloat <= 0.5F)
          {
            ...
            localRing.setStartTrim(f4 + (0.8F - f3) * f5);
          }
          if (paramAnonymousFloat > 0.5F)
          {
            f4 = (paramAnonymousFloat - 0.5F) / 0.5F;
            f4 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f4);
            localRing.setEndTrim(f2 + f4 * (0.8F - f3));
          }
          localRing.setRotation(f1 + 0.25F * paramAnonymousFloat);
  ...
  private static class Ring
  {
    ...
    private void drawTriangle(Canvas paramCanvas, float paramFloat1, float paramFloat2, Rect paramRect)
    {
      ...
      for (;;)
      {
        ...
        this.mArrow.offset(f2 - f3 * f1, f4);
        this.mArrow.close();
...
/* Location:              C:\ApkExtract\classes-dex2jar.jar!\android\support\v4\widget\MaterialProgressDrawable.class
